<template>
  <div class="page-container officer-loans-page glass-module-page" :class="{ 'light-theme': isLight }">
    ...
    <div v-if="showDetailsModal" class="modal-overlay app-modal-overlay officer-loans-modal" @click="closeModal">
      <div class="modal-content tx-detail-modal" @click.stop>
        ...
        <div
          v-if="selectedLoan && selectedLoan.status === 'pending'"
          class="modal-actions officer-pending-actions"
        >
          <button type="button" class="edit-btn primary-action" @click="editLoanFromModal">{{ $t('common.edit') }}</button>
          <button
            type="button"
    ...
    <!-- Edit Loan Modal -->
    <Transition name="app-modal">
    <div v-if="showEditModal" class="modal-overlay app-modal-overlay officer-loans-modal" @click="closeEditModal">
    ...
    <div
      ...
      class="modal-overlay app-modal-overlay receipt-modal-overlay officer-loans-modal"
...
const approvalDescription = computed(() => {
  ...
  if (role === 'treasurer') return t('ui.loanReviewedByPresident')
  if (role === 'president') return t('ui.loanReviewedByTreasurer')
  return t('ui.loanReviewedByOfficer')
})
...
@media (max-width: 768px) {
  ...
  .page-container.officer-loans-page .stats-grid {
    grid-template-columns: 1fr 1fr !important;
    gap: 6px !important;
    margin-bottom: 10px !important;
  }

  .page-container.officer-loans-page .stat-card {
    padding: 8px 10px !important;
    border-radius: 10px !important;
  }

  .page-container.officer-loans-page .stat-value {
    font-size: 0.92rem !important;
  }

  .page-container.officer-loans-page .stat-label {
    font-size: 0.58rem !important;
  }
...
@media (min-width: 769px) {
  html body .page-container.officer-loans-page.glass-module-page {
    padding: 12px 16px !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .loan-module-off-banner {
    margin-bottom: 10px !important;
  ...
  html body .page-container.officer-loans-page.glass-module-page .page-header,
  html body .page-container.officer-loans-page.glass-module-page .page-header-split {
    margin-bottom: 10px !important;
  ...
  html body .page-container.officer-loans-page.glass-module-page h1.page-title,
  html body .page-container.officer-loans-page.glass-module-page .page-title {
    font-size: 1.25rem !important;
    line-height: 1.2 !important;
    margin: 0 0 2px !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .page-subtitle {
    font-size: 0.75rem !important;
    line-height: 1.35 !important;
    margin: 0 !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .stats-group {
    margin-bottom: 10px !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .stats-group-title {
    font-size: 10px !important;
    margin-bottom: 6px !important;
    letter-spacing: 0.06em !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .stats-grid.loan-stats {
    grid-template-columns: repeat(6, minmax(0, 1fr)) !important;
    gap: 8px !important;
    margin-bottom: 0 !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .stats-grid.loan-stats .stat-card {
  ...
  html body .page-container.officer-loans-page.glass-module-page .stats-grid.loan-stats .stat-label {
    font-size: 9px !important;
    margin-bottom: 2px !important;
    line-height: 1.15 !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .stats-grid.loan-stats .stat-value {
    font-size: 1.05rem !important;
    line-height: 1.1 !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .content-grid {
    gap: 12px !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .card {
    padding: 12px 14px !important;
    border-radius: 12px !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .application-card {
    padding: 12px 14px !important;
  }

  html body .page-container.officer-loans-page.glass-module-page h2.card-title,
  html body .page-container.officer-loans-page.glass-module-page .card-title {
    font-size: 1rem !important;
    margin-bottom: 8px !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .application-card .card-title {
    font-size: 0.95rem !important;
    margin-bottom: 6px !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .alert {
    padding: 6px 10px !important;
    margin-bottom: 8px !important;
    font-size: 12px !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .form-group label,
  html body .page-container.officer-loans-page.glass-module-page .application-card .form-group label {
    font-size: 12px !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .form-group input,
  html body .page-container.officer-loans-page.glass-module-page .form-group select,
  html body .page-container.officer-loans-page.glass-module-page .input-shell input,
  html body .page-container.officer-loans-page.glass-module-page .input-shell select {
    padding: 6px 10px !important;
    font-size: 13px !important;
  ...
  html body .page-container.officer-loans-page.glass-module-page .help-text,
  html body .page-container.officer-loans-page.glass-module-page .calculation-text {
    font-size: 11px !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .loan-info-box {
    padding: 8px 10px !important;
    margin-bottom: 6px !important;
    border-width: 1px !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .loan-info-box h4 {
    font-size: 12px !important;
    margin: 0 0 4px !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .loan-info-box li {
    font-size: 11px !important;
    padding: 1px 0 !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .submit-btn {
  ...
  html body .page-container.officer-loans-page.glass-module-page .tabs {
    display: grid !important;
  ...
  html body .page-container.officer-loans-page.glass-module-page .tab {
    width: 100% !important;
    min-width: 0 !important;
  ...
  html body .page-container.officer-loans-page.glass-module-page .tab-content {
    min-height: 220px !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .empty-state {
    padding: 24px 12px !important;
    font-size: 13px !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .loans-list {
    gap: 8px !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .loan-item {
    padding: 10px 12px !important;
    border-radius: 10px !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .loan-header {
    margin-bottom: 8px !important;
    padding-bottom: 6px !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .loan-status,
  html body .page-container.officer-loans-page.glass-module-page .status-badge {
    padding: 2px 8px !important;
    font-size: 10px !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .loan-body {
    margin-bottom: 8px !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .loan-amount {
    font-size: 1.15rem !important;
    margin-bottom: 6px !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .loan-details p {
    font-size: 12px !important;
    margin: 2px 0 !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .loan-actions {
    gap: 6px !important;
  }

  html body .page-container.officer-loans-page.glass-module-page .view-btn,
  html body .page-container.officer-loans-page.glass-module-page .edit-btn {
    padding: 6px 10px !important;
    font-size: 12px !important;
  ...
  html body .page-container.officer-loans-page.glass-module-page .payment-history-table th,
  html body .page-container.officer-loans-page.glass-module-page .payment-history-table td {
    padding: 7px 8px !important;
    font-size: 12px !important;
  }

  body.glass-dark .page-container.officer-loans-page.glass-module-page :is(.submit-btn, .view-btn, .edit-btn, .tab, .btn, .btn-primary, .btn-secondary),
  body.glass-light .page-container.officer-loans-page.glass-module-page :is(.submit-btn, .view-btn, .edit-btn, .tab, .btn, .btn-primary, .btn-secondary),
  body.glass-dark .officer-loans-modal :is(.submit-btn, .view-btn, .edit-btn, .close-btn, .btn-primary, .btn-secondary),
  body.glass-light .officer-loans-modal :is(.submit-btn, .view-btn, .edit-btn, .close-btn, .btn-primary, .btn-secondary) {
    border-radius: 8px !important;
    font-weight: 600 !important;
  }

  body.glass-dark .page-container.officer-loans-page.glass-module-page :is(.submit-btn, .view-btn, .edit-btn),
  body.glass-light .page-container.officer-loans-page.glass-module-page :is(.submit-btn, .view-btn, .edit-btn) {
    border-width: 0 !important;
  }

  body.glass-dark .page-container.officer-loans-page.glass-module-page .tab,
  body.glass-light .page-container.officer-loans-page.glass-module-page .tab {
    border-width: 1px !important;
  }

  .officer-loans-modal .modal-header {
    padding: 12px 16px !important;
  }

  .officer-loans-modal .modal-header h3 {
    font-size: 16px !important;
    margin: 0 !important;
  }

  .officer-loans-modal .modal-body {
    padding: 12px 16px !important;
  }

  .officer-loans-modal .details-grid {
    gap: 12px !important;
  }

  .officer-loans-modal .detail-item label {
    font-size: 12px !important;
  }

  .officer-loans-modal .detail-item p {
    font-size: 13px !important;
  }

  .officer-loans-modal .form-group input,
  .officer-loans-modal .form-group select {
    padding: 6px 10px !important;
    font-size: 13px !important;
    min-height: 32px !important;
    border-width: 1px !important;
  ...
  .officer-loans-modal .modal-actions button,
  .officer-loans-modal .submit-btn,
  .officer-loans-modal .view-btn,
  .officer-loans-modal .edit-btn {
    padding: 6px 14px !important;
    font-size: 13px !important;
    min-height: 32px !important;
    border-radius: 8px !important;
