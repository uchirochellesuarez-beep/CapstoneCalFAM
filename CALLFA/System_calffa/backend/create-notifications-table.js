  ...
  try {
    await pool.execute(`
      CREATE TABLE IF NOT EXISTS due_date_notifications (
        ...
        reference_type ENUM('loan', 'machinery_booking', 'income_assistance_distribution') NOT NULL,
        reference_id INT(11) NOT NULL,
        notification_type ENUM('last_month', 'last_week', '3_days', '2_days', '1_day', 'due_day', 'overdue_penalty', 'booking_approved', 'booking_rejected', 'booking_expired', 'assistance_allocated') NOT NULL,
